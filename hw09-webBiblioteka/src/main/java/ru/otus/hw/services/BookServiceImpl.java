...
public class BookServiceImpl implements BookService {
    ...
    public BookDto insert(CreateBookRequestDto requestDto) {
        return save(0, requestDto.title(), requestDto.authorId(), requestDto.genreIds());  // ИСПРАВЛЕНО
    }

    @Override
    @Transactional
    public BookDto update(long id, UpdateBookRequestDto requestDto) {
        return save(id, requestDto.title(), requestDto.authorId(), requestDto.genreIds());  // ИСПРАВЛЕНО
    }
