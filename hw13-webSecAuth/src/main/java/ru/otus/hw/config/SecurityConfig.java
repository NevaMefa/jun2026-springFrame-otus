...
public class SecurityConfig {
    ...
    private void configureAuthorizeRequests(
            org.springframework.security.config.annotation.web.builders.AuthorizeHttpRequestsConfigurer
        ...
        authz
                ...
                .requestMatchers(HttpMethod.POST, "/api/v1/genre").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/v1/genre/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/genre/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.POST, "/api/v1/comment").hasRole("ADMIN")
                .requestMatchers(HttpMethod.PUT, "/api/v1/comment/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/api/v1/comment/**").hasRole("ADMIN")
                .requestMatchers(HttpMethod.GET, "/api/v1/book/**").hasAnyRole("USER", "ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/comment/**").hasAnyRole("USER", "ADMIN")
