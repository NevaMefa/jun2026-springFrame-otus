...
class SecurityParameterizedTest {
    ...
    @ParameterizedTest
    @MethodSource("provideEndpointsWithAuth")
    @WithMockUser
    void shouldReturnSuccessWhenAccessingWithUserAuth(String url, String method, String requestBody, int expectedStatus)
            throws Exception {
        mockMvc.perform(buildRequest(method, url, requestBody))
    ...
    void shouldReturnSuccessWhenAccessingWithAdminAuth(String url, String method, String requestBody, int expectedStatus)
            throws Exception {
        mockMvc.perform(buildRequest(method, url, requestBody))
                .andExpect(status().is(expectedStatus));
    }
    ...
    private static Stream<Arguments> provideEndpointsWithAuth() {
        return Stream.of(
                Arguments.of("/api/v1/book", "GET", "", 200),
                Arguments.of("/api/v1/book/1", "GET", "", 200),
                ...
                Arguments.of("/api/v1/author", "GET", "", 200),
                Arguments.of("/api/v1/author/1", "GET", "", 200),
                ...
                Arguments.of("/api/v1/genre", "GET", "", 200),
                Arguments.of("/api/v1/genre/1", "GET", "", 200),
                ...
                Arguments.of("/api/v1/comment?bookId=1", "GET", "", 200),
                Arguments.of("/api/v1/comment/1", "GET", "", 200),
